    ...
    >
      ...
      >
        <input
          ...
          type="text"
          placeholder="Email"
          className="outline-0 border-0 border-sky-200 border-b-[1px] w-full p-2 bg-transparent focus:outline-accent focus:bg-transparent"
        />
        ...
        <button
          type="submit"
          className="w-full p-2 border-0 mt-4 outline-0 outline-blue-600 bg-accent px-4 py-2 "
        >
          Sign in
        </button>
      </form>
