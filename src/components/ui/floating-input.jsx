...
// FloatingInput (just the input field with peer styling)
...
// FloatingLabel (label that floats when input is focused or filled)
...
// Wrapper component that combines both
