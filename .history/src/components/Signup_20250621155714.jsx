...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const session = supabase.auth.getgetSession()
  ...
  return (
    <div
      className="relative w-full h-full flex flex-col justify-center items-center flex-2 gap-4 p-5 bg-black"
      id="left"
    >
      ...
      >
        <input
          ...
          className="outline-o border-0 border-sky-200 border-b-[1px] w-full p-2 bg-transparent focus:outline-0  focus:bg-transparent"
        />
        ...
        <button
          type="submit"
          className="w-full p-2 border-0 outline-1 outline-blue-600  bg-accent px-4 py-2 "
        >
          Sign up
        </button>
      </form>
      ...
      <button onClick={handleSwitchToSignin} className="bg-transparent">
        Switch to signin
      </button>
    </div>
  )
