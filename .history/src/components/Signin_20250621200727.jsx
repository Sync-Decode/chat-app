...
const Signin = () => {
  ...
  return (
    <div
      className="relative w-full h-full flex flex-col justify-center items-center flex-2 gap-4 bg-gray-900"
      id="left"
    >
      <Logo />
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          <input
            ...
            className="text-gray-400 outline-0 border-0 border-gray-200/25 border-b-[1px] w-full p-2 bg-transparent focus:outline-accent focus:bg-transparent"
          />
