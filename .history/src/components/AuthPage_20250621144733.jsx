...
const AuthPage = ({ children }) => {
  ...
  return (
    <div className="w-full h-[75vh] flex flex-col gap-4 max-w-5xl m-auto  rounded-lg overflow-hidden outline outline-[#0d6cea]  text-white ">
      <div className="w-full h-full flex flex-1 p-4">
        {/* left */}
        <div className="w-full h-full flex-2 " id="left">
          <div className="w-full h-full flex justify-start items-center p-">
            {children}
          </div>
        </div>
