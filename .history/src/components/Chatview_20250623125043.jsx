...
export default function ChatView({ chatId }) {
  ...
  return (
    <div className="flex-1 flex flex-col  w-full h-full bg-transparent ">
      ...
      >
        <div className="w-full rounded-full border border-gray-900 flex items-center bg-gray-500">
          <input
            type="text"
            value={newMessage}
            onChange={(e) => setNewMessage(e.target.value)}
            className="flex-1 px-4 py-2 border-none rounded-full outline-none"
