...
export default function ChatView({ chatId }) {
  ...
  return (
    <div className="relative flex-1 flex flex-col w-full h-full bg-black/25 bg-[url('/bg-svg.svg')] bg-blend-multiply bg-cover bg-center bg-opacity-25">
            ...
            >
              <img
                ...
                className={`w-5 h-5 rounded-full ${
                  msg.sender_id === currentUserId ? 'order-2 ml-2' : ''
                }`}
              />
