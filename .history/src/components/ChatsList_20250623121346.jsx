...
const ChatsList = () => {
  ...
  useEffect(() => {
    ...
    const fetchAndUpdateChats = async () => {
      // (your fetchChats logic here)
    }

    fetchAndUpdateChats() // Initial load
  ...
  return (
    <div className="relative w-full h-full overflow-y-auto ">
      <form action="" className="sticky top-0 bg-gray-900">
            ...
            <div
              ...
              onClick={() => {
                ...
                if (chat.type === 'dm') {
                  ...
                  setOtherUser(null) // or leave it untouched for group chats
                }
                setActiveChat(chat)
              }}
            >
