  ...
  return (
    <div className="w-full h-full  flex flex-col gap-4 max-w-5xl m-auto  rounded-lg overflow-hidden bg-gray-900   text-white ">
      <div className="w-full h-full flex flex-1 p-4">
        ...
        {!isMobile && (
          <div
            className="relative w-full h-full min-[768px]:flex-2 min-[1024px]:flex-3 bg-amber-400 trapezoid-clip rounded-bl-2xl rounded-tl-2xl flex justify-center items-center"
            id="right"
          >
            {/* <img
              src="/bg.jpg"
