...
const ConfirmEmail = () => {
  ...
  return (
    <div className="w-full h-[75vh] flex flex-col gap-4 max-w-5xl m-auto rounded-lg overflow-hidden  text-gray-100 ">
      <div className="w-full h-full flex flex-col justify-center items-center p-5 rounded-lg shadow-md">
        ...
        <button
          ...
          className="px-4 py-2 flex-none w-fit bg-amber-400 text-gray-900 rounded hover:bg-amber-500"
        >
