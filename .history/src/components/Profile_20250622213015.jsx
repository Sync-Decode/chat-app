...
import { useChatStore, useUserProfileStore, useViewStore } from '@/store/store'
...
export default function Profile() {
  ...
  const otherUserID = useChatStore((s) => s.otherUser.user_id)
  ...
  return (
    <div className="w-full h-full flex flex-col border-l border-gray-500/25  p-4 bg-gray-900 border-0">
      {!currentProfile ? (
        <div className="relative flex-1 flex flex-col justify-center items-center py-4 gap-4 ">
          <h3 className="text-xl text-center mb-4">Select a user to view</h3>
          {!isDesktop && (
            <div
        ...
        <div className="relative flex-1 flex flex-col justify-start items-center py-4 gap-4 bg-gray-900">
          ...
          <div className="w-full py-4 flex justify-center items-center" onClick={()=>upsertChat}>
