...
export default function Profile() {
  ...
  return (
    <div className="w-full h-full flex flex-col border-l border-gray-500/50  p-4 bg-gray-900 border-0">
      <div className="relative flex-1 flex flex-col justify-start items-center py-4 gap-4 bg-gray-900">
        <div className="flex justify-center items-center">
          {!isDesktop && (
            <div onClick={() => setView('chat')} className="absolute left-4">
        ...
        <div className="flex flex-col gap-2 ">
          <h4 className="text-center">{currentProfile.username}</h4>
