...
const Signin = () => {
  ...
  return (
    <div
      className="relative w-full h-full flex flex-col justify-center items-center flex-2 gap-6 bg-gray-900"
      id="left"
    >
      <Logo />
      ...
      <form
        ...
        className="w-full max-md:max-w-xl flex flex-col px-4 gap-6"
      >
        <input
          ref={emailRef}
          value={email}
          ...
          type="text"
          placeholder="Email"
          className="outline-0 border-0 border-gray-200/25 border-b-[1px] w-full text-sm placeholder:text-sm p-2 bg-transparent focus:outline-accent focus:bg-transparent"
        />
        ...
        <div className="flex flex-col gap-2">
          ...
          <div
            ...
            className="w-full flex justify-center text-xs text-gray-400 cursor-pointer hover:text-amber-500 hover:underline"
          >
            <p>forgot password </p>
          </div>
        </div>
        ...
        <button
          type="submit"
          className="w-full p-2 border-0 mt-4 bg-amber-400 px-4 py-2 rounded "
        >
