...
const Signin = () => {
  ...
  return (
    <div
      className="relative w-full h-full flex flex-col justify-center items-center flex-2 gap-8 p-5 bg-gray-900"
      id="left"
    >
        <Logo />
      ...
      <div className='flex flex-col gap-4'>
        ...
        <button onClick={handleSwithToSignup} className="bg-transparent text-sm">
