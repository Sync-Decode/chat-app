...
export default function Sidebar() {
  ...
  return (
    <div className="relative w-full h-full flex  bg-gray-900 text-white">
      <div className="flex-1 flex flex-col justify-start items-center gap-8 border-r border-gray-500/25">
        <div onClick={() => setIsMenuHidden((prev) => !prev)}>
          <Hamburger />
        </div>

        <div className="flex flex-col gap-4">
          <PiChatsFill width={48} height={48} />
          <IoPeople width={48} height={48} />
        </div>
