  ...
  return (
    <div className="w-full h-full flex flex-col border-l border-gray-500/25  p-4 bg-gray-900 border-0">
      <div className="relative flex-1 flex flex-col justify-start items-center py-4 gap-4 bg-gray-900">
        ...
        <div className="w-64 min-[768px]:w-48 flex-shrink aspect-square rounded-full overflow-hidden">
          <img
        ...
        <div><span className='text-gray-400'>last seen:</span>{" "}{formatDate(currentProfile?.last_seen)}</div>
      </div>
    </div>
  )
}
